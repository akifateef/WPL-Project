...
<head>
	...
	<title>IDDb - Zindagi Gulzar Hai</title>
...
<br>
	...
	<!-- end Header -->
        ...
        <br>
        <center>
         <h1><a href="zindagi1.php">Zindagi Gulzar Hai</h1>
          <video controls poster="images/zindagigulzarhai.jpg"
               width="800" height="480">
                <source src="zindagigulzarhai.mp4" type="video/mp4">
                <source src="zindagigulzarhai.ogv" type="video/ogg">
                </video>
