...
<br>
	...
	<!-- end Header -->
    <marquee scrolldelay="10" behavior="scroll" scrollamount="8" direction="right" onMouseOver="stop()" onMouseOut="start()" >
         
         
         <a href="showall.html">
         <img src="images/abdulqadir.jpg" >
         <img src="images/PyaareAfzal-marquee.jpg" >
         <img src="images/zindagigulzarhai-poster.jpg" >
         <img src="images/humsafar1.jpg" >
         <img src="images/dil-e-muztar-poster.jpg" >
         <img src="images/Mastana_Mahi_poster.jpg" >
         <img src="images/noorbano-poster.jpg" >
         <img src="images/Numm_poster.jpg" >
         <img src="images/RangLaga-poster.jpg" >
         <img src="images/bulbulay-poster.jpg" >
         <img src="images/abdulqadir.jpg" >
         <img src="images/PyaareAfzal-marquee.jpg" >
         <img src="images/zindagigulzarhai-poster.jpg" >
         <img src="images/humsafar1.jpg" >
        ...
        <center>
        <h1>Recent: Pakistani Award Show</h1>
        </center>
			...
			<ul id="slider1">
				...
				<li><img class="abcd" src="demos/images/award5.jpg" alt=""></li>

				<li><img class="abcd" src="demos/images/award2.jpg" alt=""></li>

				<li><img class="abcd" src="demos/images/award3.jpg" alt=""></li>

				<li><img class="abcd" src="demos/images/award7.jpg" alt=""></li>

				<li><img class="abcd" src="demos/images/award1.jpg" alt=""></li>

				<li><img class="abcd" src="demos/images/award6.jpg" alt=""></li>
         ...
         <div id="aftermarquee1">
         
         <br>
         <center><a href="news.html"><h1>Latest News</h1></a>
         ...
         <a href="weeklypicks.html"><img src="images/fawadkhan-news.jpg" ></a>
         <br>
         ...
         <a href="weeklypicks.html"><img src="images/ayyanali-news.jpg" ></a>
         <br>
...
Ayyan’s lawyer also objected that the presented charge-sheet pertaining to her case was incomplete, whereby a complete map of the crime scene was not provided. There are two more suspects for the interrogation and that needs to be highlighted in the interim charge-sheet.</p>
		...
		<br> 
         ...
         <a href="weeklypicks.html"><img src="images/alizafar-news.jpg" ></a>
         <br>
...
The versatile Ali recently bagged the ‘Most Stylish Import’ award at the Hindustan Times Style Awards in March and considered as the most hip and cools actor signature sense of style.</p>
         ...
         <div id="aftermarquee2">
         
         <br>
         <center><a href="weeklypicks.html"><h1>IDDb's Weekly Picks</h1></a>
         <p>View our TV Editor's list of new and returning dramas, as well as episodes you won't want to miss this week!</p>
		 <br>
         <br>
         <a href="weeklypicks.html"><img src="images/saraloren-picks.jpg" ></a>
         <a href="weeklypicks.html"><img src="images/sabaqamar-picks.jpg" ></a>
         <a href="weeklypicks.html"><img src="images/atifaslam-picks.jpg" ></a>
