...
<br>
	...
	<!-- end Header -->
        ...
        <br>
        <center>
         <h1><a href="pyareafzal.php">Pyare Afzal</h1>
          <video controls poster="images/piyareafzal.jpg"
               width="800" height="480">
                <source src="afzal.mp4" type="video/mp4">
                <source src="afzal.ogv" type="video/ogg">
                </video>
