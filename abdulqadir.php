...
<head>
	...
	<title>IDDb - Mein Abdul Qadir Hoon</title>
...
<br>
	...
	<!-- end Header -->
        ...
        <br>
        <center>
         <h1><a href="mainabdulqadirhoon.php">Mein Abdul Qadir Hoon</h1>
          <video controls poster="images/abdulqadir.jpg"
               width="800" height="480">
                <source src="abdulqadir.mp4" type="video/mp4">
                <source src="abdulqadir.ogv" type="video/ogg">
