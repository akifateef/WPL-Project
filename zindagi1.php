...
<br>
	...
	<!-- end Header -->
        ...
        <br>
		<center>
        <h1>Zindagi Gulzar Hai</h1>
        TV Series | 35 min
        <br/><br/>

		<div id="photo">
        <img src="images/gulzar.jpg">
        </div>
        
        
        <br>
        <h2>Ratings 8.8</h2>
        Ratings 8.8/10 from 626 users
        <br>
        <br>
        </center>
        ...
        <div id="minibio">
        <h2>Summary</h2>
        <p>A school teacher was left by her husband with her 3 daughters and marries another women for the sake of getting a male child. The story focuses on gender biasness and the difference between the classes in terms of the affluence level. </p>
        ...
        <table>
        <tr>
        <td width="150" height="30"><a href="fawadkhan.php">Fawad Khan</a></td>
        <td width="350">Zaroon Junaid / ... (9 episodes, 2012) </td>
        </tr>
        <tr>
        <td height="30"><a href="sanamsaaed.php">Sanam Saeed</a></td>
        <td>Kashaf Murtaza / ... (9 episodes, 2012) </td>
        </tr>
        </table>
        </div>
