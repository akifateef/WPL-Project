...
<head>
	...
	<title>IDDb - Na Maloom Afraad</title>
...
<br>
	...
	<!-- end Header -->
        ...
        <br>
        <center>
         <h1>Na Maloom Afraad</h1>
          <video controls poster="images/namaloom-poster.jpg"
               width="800" height="480">
                <source src="namaloomafrad.mp4" type="video/mp4">
                <source src="namaloomafrad.ogv" type="video/ogg">
