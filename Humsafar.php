...
<br>
	...
	<!-- end Header -->
		...
		<div id="photo">
        <img src="images/humsafar.jpg">
        </div>
        
        
        <br>
        <h2>Ratings 8.8</h2>
        Ratings 8.8/10 from 837 users
        <br>
        <br>
        </center>
        ...
        <td width="350">Ashar / ... (9 episodes, 2012) </td>
        </tr>
        <tr>
        <td height="30"><a href="mahirakhan.php">Mahira Khan</a></td>
        <td>Khirad / ... (9 episodes, 2012) </td>
        </tr>
        </table>
        </div>
