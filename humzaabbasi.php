...
<br>
	...
	<!-- end Header -->
        ...
        <td width="350">Hamza Ali Abbasi</td>
        </tr>
        <tr>
        ...
        <div id="minibio">
        <h2>Mini Bio</h2>
        <p>Hamza Ali Abbasi is a Pakistan based actor, model, director and film maker. His movie count is 4, He has directed one also. His cause of fame is the character played in a Television soap serial "Pyarey Afzal". His studies are USA based and has appeared in many commercials and theater productions as well.</p>
        </div>
